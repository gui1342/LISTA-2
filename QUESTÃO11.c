//(**questão anterior**)10.Elabore um programa que apresente os quadrados dos números inteiros múltiplos de 4 existentes na faixa de valores de 15 a 90.
...
int main(){
  int a, b, ab/*tamanho do vetor*/, *vetor/*vetor principal*/, maior, menor, *mult4/*vetor com os multiplos de 4*/, qtd = 0/*quantidade de números multiplos de 4*/;
  ...
  free(mult4); //liberar memória alocada
